...
GOLDEN = [
    ("202104_5836_AI3", "富邦", "年報",   "掃描圖 BS,Trading 手動採信"),
    ("202202_5836_AI3", "富邦", "半年報", "掃描圖,Trading+OCI 兩格手動採信"),
    ("202102_5841_AI3", "中信", "半年報", "掃描圖,Trading 手動採信(疑吞列:錨≈T+O)"),
    ("202504_5843_AI3", "兆豐", "年報",   "表格內文字元湯"),
    ("202502_5843_AI3", "兆豐", "半年報", "兆豐半年報基準"),
    ("202504_5835_AI3", "國泰", "年報",   "曾鎖到「證券部門」子報表"),
    ("202304_5836_AI3", "富邦", "年報",   "曾鎖錯表"),
    ("202504_5847_AI3", "玉山", "年報",   "擴頁案例"),
    ("202504_5841_AI1", "中信", "合併年報", "無「重要會計項目明細表」章"),
    ("202502_5841_AI3", "中信", "半年報", "中信個體半年報基準"),
]

# 要盲抄逐桶的 4 份(四種難法 × 兩種來源)
BUCKET_BLIND = {"202202_5836_AI3", "202504_5843_AI3", "202504_5835_AI3", "202504_5841_AI1"}
