...
按攤銷後成本(AC)」三分類的債券債種明細,產出含**原生 Excel 圖表**的報表 + 網頁。
...
| 產物 | 給誰 | 怎麼來 |
|---|---|---|
| **網頁** https://henrylin1009.github.io/auto-reports/ | 給人看/下載 | 本機產資料 → push → GitHub Actions 發佈 |
...
| `make_web.py` | 讀 data.json/xlsx 產網頁(給 GitHub Actions 用) |
